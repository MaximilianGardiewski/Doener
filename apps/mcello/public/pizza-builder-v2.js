...
const presentationIngredients = ["Kebab Fleisch", "Tomaten", "Broccoli", "Käse", "Zwiebeln"];
...
function pizzaSvg(selected) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 720" role="img" aria-label="Schematische interaktive Pizza-Vorschau">
    ...
    ${layer("Kebab Fleisch", `<g fill="#7b412b" stroke="#a8663f" stroke-width="5" stroke-linejoin="round"><path d="M203 347l71-28 32 42-71 31Z"/><path d="M397 368l76-21 27 42-72 31Z"/><path d="M310 378l69-25 25 40-67 31Z"/><path d="M385 218l67 12-13 47-68-15Z"/><path d="M277 488l68-23 25 39-65 31Z"/></g>`)}
