...
test("active product editor uses one configured product transaction and preserves separately managed labels", () => {
  assert.match(admin, /admin_save_menu_product_configured/);
