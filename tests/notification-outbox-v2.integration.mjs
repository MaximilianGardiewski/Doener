...
assert.equal(claimed.data[0].preferred_channel, "whatsapp");
assert.equal(claimed.data[0].fallback_channel, null);
...
assert.equal(jobs.every((job) => job.preferred_channel === "whatsapp" && job.fallback_channel === null), true);
